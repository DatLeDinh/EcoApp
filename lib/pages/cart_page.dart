...
import 'package:shopping_ui/models/cartlist.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  getData() async {
    cartLists = await Remote().getCartlists();
    if (cartLists != null) {
      setState(() {
        isLoaded = true;
      });
    ...
    return ListView(
      children: [
        Column(
            ...
            children: List.generate(cartLists.length, (index) {
          return Column(
            children: [
              Padding(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                              ...
                              image: NetworkImage(cartLists[index].img),
                              fit: BoxFit.cover)),
                    ),
                    SizedBox(
                      width: 20,
